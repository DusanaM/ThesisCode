...
class SAC_Agent():
    def __init__(self, input_dims, max_action = 1, alpha=0.003, beta = 0.003, gamma = 0.99, n_actions = 2, memory_size = 1000, tau = 0.005, layer1 = 256 , layer2 = 256, batch_size = 256, reward_scale = 2): 
